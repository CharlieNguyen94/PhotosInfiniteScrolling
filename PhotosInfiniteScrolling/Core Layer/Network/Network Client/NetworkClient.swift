...
final class NetworkClient {
    ...
    func get<T: Decodable>(_ type: T.Type,
                           ...
                           printURL: Bool = false) -> Observable<(T?, Error?)> {
    ...
    // MARK: - Basic GET Data
    /// This method does not depend on baseURL property, so it makes sense to use it without instantiating the Network Client
